...
export const PROVIDER_CATALOG: ProviderSpec[] = [
  { value: "anthropic", label: "Anthropic", sdk: "anthropic", baseUrl: null, defaultModel: "claude-sonnet-4-5" },
  { value: "openai", label: "OpenAI", sdk: "openai-compat", baseUrl: null, defaultModel: "gpt-4o" },
  { value: "google", label: "Google Gemini", sdk: "google", baseUrl: null, defaultModel: "gemini-2.5-flash" },
  { value: "deepseek", label: "DeepSeek", sdk: "openai-compat", baseUrl: "https://api.deepseek.com/v1", defaultModel: "deepseek-chat" },
  { value: "openrouter", label: "OpenRouter", sdk: "openai-compat", baseUrl: "https://openrouter.ai/api/v1", defaultModel: "openai/gpt-4o" },
  { value: "groq", label: "Groq", sdk: "openai-compat", baseUrl: "https://api.groq.com/openai/v1", defaultModel: "llama-3.3-70b-versatile" },
  { value: "mistral", label: "Mistral", sdk: "mistral", baseUrl: null, defaultModel: "mistral-large-latest" },
  { value: "xai", label: "xAI Grok", sdk: "xai", baseUrl: null, defaultModel: "grok-3" },
  { value: "togetherai", label: "Together AI", sdk: "openai-compat", baseUrl: "https://api.together.xyz/v1", defaultModel: "meta-llama/Llama-3-70b-chat-hf" },
  { value: "fireworks", label: "Fireworks AI", sdk: "openai-compat", baseUrl: "https://api.fireworks.ai/inference/v1", defaultModel: "accounts/fireworks/models/llama-v3p1-70b-instruct" },
  { value: "cohere", label: "Cohere", sdk: "openai-compat", baseUrl: "https://api.cohere.com/compatibility/v1", defaultModel: "command-r-plus" },
  { value: "perplexity", label: "Perplexity", sdk: "openai-compat", baseUrl: "https://api.perplexity.ai", defaultModel: "sonar-pro" },
  { value: "zhipu", label: "Z.AI (Zhipu)", sdk: "openai-compat", baseUrl: "https://open.bigmodel.cn/api/paas/v4", defaultModel: "glm-4" },
